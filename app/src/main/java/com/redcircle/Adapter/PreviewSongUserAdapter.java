...
public class PreviewSongUserAdapter extends RecyclerView.Adapter<PreviewSongUserAdapter.MyViewHolder> {

    private ArrayList<UserPreviewSong> mProductList;
    private LayoutInflater inflater;
    private String TAG = "SongAdp";
    private ImagePopup imagePopup;

    public PreviewSongUserAdapter(Context context, ArrayList<UserPreviewSong> products) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_previewsong, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        UserPreviewSong selectedProduct = mProductList.get(position);
