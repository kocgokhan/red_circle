...
public class AlbumTrackAdapter extends RecyclerView.Adapter<AlbumTrackAdapter.MyViewHolder> {
    ...
    private ArrayList<AlbumTrack> mProductList;
    private LayoutInflater inflater;
    private String TAG = "SongAdp";
    private ImagePopup imagePopup;

    public AlbumTrackAdapter(Context context, ArrayList<AlbumTrack> products) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_track_album, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        AlbumTrack selectedProduct = mProductList.get(position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(AlbumTrack selectedProduct, int position) {

            this.prev_songname.setText(selectedProduct.getTrack_name());
        ...
        public void song_post(Context context){
            ...
            i.putExtra("song_uri", mProductList.get(getAdapterPosition()).getTrack_uri());
        ...
        public void play_song(Context context){
            ...
            String song_uri= mProductList.get(getAdapterPosition()).getTrack_uri();
