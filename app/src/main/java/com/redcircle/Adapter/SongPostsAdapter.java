...
public class SongPostsAdapter extends RecyclerView.Adapter<SongPostsAdapter.MyViewHolder> {

    private ArrayList<SongPost> mProductList;
    private LayoutInflater inflater;
    private String TAG = "SongAdp";
    private ImagePopup imagePopup;


    public SongPostsAdapter(Context context, ArrayList<SongPost> products) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_song_post_cycle, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        SongPost selectedProduct = mProductList.get(position);
