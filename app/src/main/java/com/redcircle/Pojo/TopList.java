...
public class TopList {
    ...
    public TopList(JSONObject response, boolean isLogin) {
        try {
    ...
    public static ArrayList<TopList> getData (ArrayList<TopList> ary) {
        ArrayList<TopList> productList = new ArrayList<TopList>();
