...
public class UserPreviewSong {
    ...
    public static ArrayList<UserPreviewSong> getData (ArrayList<UserPreviewSong> ary) {
        ArrayList<UserPreviewSong> productList = new ArrayList<UserPreviewSong>();

        for (int i = 0; i < ary.size(); i++) {
            UserPreviewSong temp = new UserPreviewSong();
